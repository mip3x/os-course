...
- [Заголовки секций](#Заголовки-секций)
  ...
  - [Пример вывода различных типов секций](#Пример-вывода-различных-типов-секций)
...
- [Символы](#Символы)
  - [Структура символа](#Структура-символа)
  - [Разбиение символов по виду локальности (биндинг)](#Разбиение-символов-по-виду-локальности-биндинг)
  - [Разбиение на секции](#Разбиение-на-секции)
  - [Про `common`-символы](#Про-common-символы)
    - [Пример c `common symbol`](#Пример-c-common-symbol)
  - [Особенности поведения линковщика и немного про релокации](#Особенности-поведения-линковщика-и-немного-про-релокации)
    - [Пример корректной и некорректной цели в Makefile](#Пример-корректной-и-некорректной-цели-в-Makefile)
  - [Релокации](#Релокации)
    - [Типы релокации](#Типы-релокации)
      - [`R_X86_64_PC32`](#R_X86_64_PC32)
    - [Что делает `strip`?](#Что-делает-strip)
- [Линковка](#Линковка)
  - [Статическая и динамическая линковка](#Статическая-и-динамическая-линковка)
    - [Статическая](#Статическая)
    - [Динамическая](#Динамическая)
    - [Пример описания сегментов](#Пример-описания-сегментов)
- [PLT (Procedure Linkage Table) & GOT (Global Offset Table)](#PLT-Procedure-Linkage-Table--GOT-Global-Offset-Table)
